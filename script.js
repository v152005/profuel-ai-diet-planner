...
const foods = [
  ...
  { id: 'soya',      type: 'veg',    sports: ['gym', 'cross'],       name: 'Soya Chunks (100g)',    emoji: '🌱', protein: 52, calories: 345, carbs: 33, fat: 1,  img: 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=600&q=80' },
  ...
  { id: 'almonds',   type: 'veg',    sports: ['gym', 'yoga'],        name: 'Almonds (100g)',         emoji: '🌰', protein: 21, calories: 579, carbs: 22, fat: 50, img: 'https://images.unsplash.com/photo-1574570049571-eca29f95e836?w=600&q=80' },
  { id: 'quinoa',    type: 'veg',    sports: ['run', 'swim', 'cycle'], name: 'Quinoa (100g)',        emoji: '🌾', protein: 14, calories: 368, carbs: 64, fat: 6,  img: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600&q=80' },
  { id: 'lentils',   type: 'veg',    sports: ['run', 'field'],       name: 'Red Lentils (100g)',    emoji: '🍲', protein: 26, calories: 353, carbs: 60, fat: 1,  img: 'https://images.unsplash.com/photo-1516714435131-44d6b64dc6a2?w=600&q=80' },
  { id: 'chickpeas', type: 'veg',    sports: ['run', 'field'],       name: 'Chickpeas (100g)',      emoji: '🫘', protein: 19, calories: 364, carbs: 61, fat: 6,  img: 'https://images.unsplash.com/photo-1515543237350-b3eea1ec8082?w=600&q=80' },
  { id: 'greengram', type: 'veg',    sports: ['cycle', 'swim'],      name: 'Green Gram (100g)',     emoji: '🟢', protein: 24, calories: 347, carbs: 63, fat: 1,  img: 'https://images.unsplash.com/photo-1608686207856-001b95cf60ca?w=600&q=80' },
  ...
  { id: 'yogurt',    type: 'veg',    sports: ['yoga', 'combat'],     name: 'Greek Yogurt (100g)',   emoji: '🥣', protein: 10, calories: 97,  carbs: 4,  fat: 5,  img: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=600&q=80' },
  { id: 'edamame',   type: 'veg',    sports: ['yoga', 'swim'],       name: 'Edamame (100g)',        emoji: '🫛', protein: 11, calories: 122, carbs: 10, fat: 5,  img: 'https://images.unsplash.com/photo-1648360578757-a69c8e22e4bb?w=600&q=80' },
  { id: 'oats',      type: 'veg',    sports: ['run', 'cycle', 'swim'], name: 'Oats (100g)',         emoji: '🌀', protein: 17, calories: 389, carbs: 66, fat: 7,  img: 'https://images.unsplash.com/photo-1517673132405-a56a62b18caf?w=600&q=80' },
  ...
  { id: 'chicken',   type: 'nonveg', sports: ['gym', 'cross', 'field'], name: 'Chicken Breast (100g)', emoji: '🍗', protein: 31, calories: 165, carbs: 0, fat: 3,  img: 'https://images.unsplash.com/photo-1604503468506-a8da13d11560?w=600&q=80' },
  ...
  { id: 'whitefish', type: 'nonveg', sports: ['swim', 'combat'],     name: 'White Fish (100g)',     emoji: '🐡', protein: 22, calories: 105, carbs: 0,  fat: 2,  img: 'https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?w=600&q=80' },
  { id: 'sardines',  type: 'nonveg', sports: ['cycle', 'run'],       name: 'Sardines (100g)',       emoji: '🐟', protein: 25, calories: 208, carbs: 0,  fat: 11, img: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=600&q=80' }
];
